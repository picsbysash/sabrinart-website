...
const ART = {
  ...
  summer: 'assets/art/Summer.jpg',
  billabong: 'assets/art/billabong.jpg',
  waterSplash: 'assets/art/water-splash.png',
  desertStorm: 'assets/art/desert-storm.png',
  abyss: 'assets/art/abyss.jpg',
  goldfields: 'assets/art/goldfields.png',
  hawaii: 'assets/art/hawaii.png',
  lava: 'assets/art/lava.jpg',
  magnolia: 'assets/art/magnolia.jpg',
  planet: 'assets/art/planet.jpg',
  marriage: 'assets/art/marriage.jpg',
  powerOfLove: 'assets/art/the-power-of-love.png',
...
const WORKS_CATALOG = [
  ...
  { t: 'Silver Sea', year: '2019', sizeIn: '18 × 18 in', sizeCm: '46 × 46 cm', medium: 'Mixed Media', price: '$670', status: 'ON SALE', col: 'available', src: ART.silverSea, pal: ['ocean'] },
  { t: 'Gold Droplets', year: '2019', sizeIn: '18 × 18 in', sizeCm: '45 × 45 cm', medium: 'Mixed Media', price: '$620', status: 'SOLD', col: 'available', src: ART.goldDroplets, pal: ['gold', 'cerise'] },
  { t: 'Carnival', year: '2019', sizeIn: '12 × 12 in', sizeCm: '30.5 × 30.5 cm', medium: 'Mixed Media', price: '$420', status: 'ON SALE', col: 'available', src: ART.carnival, pal: ['nature', 'ocean'] },
  { t: 'Butterfly', year: '2024', sizeIn: '12 × 12 in', sizeCm: '30 × 30 cm', medium: 'Mixed Media', price: '$480', status: 'ON SALE', col: 'available', src: ART.butterfly, pal: ['cerise'] },
  { t: 'Party Time', year: '2024', sizeIn: '16 × 12 in', sizeCm: '40 × 30 cm', medium: 'Mixed Media', price: '$320', status: 'ON SALE', col: 'available', src: ART.partyTime, pal: ['fire', 'nature'] },
  { t: 'Fly Over the Sea', year: '2024', sizeIn: '10 × 10 in', sizeCm: '25 × 25 cm', medium: 'Mixed Media', price: '$210', status: 'ON SALE', col: 'available', src: ART.flyOnTheSea, pal: ['ocean'] },
  { t: 'Fun', year: '2024', sizeIn: '10 × 10 in', sizeCm: '25 × 25 cm', medium: 'Oil on Canvas', price: '$210', status: 'ON SALE', col: 'available', src: ART.oilPainting, pal: ['fire'] },
  { t: 'Autumn', year: '2024', sizeIn: '10 × 10 in', sizeCm: '25 × 25 cm', medium: 'Oil on Canvas', price: '$210', status: 'ON SALE', col: 'available', src: ART.autumn, pal: ['fire'] },
  { t: 'Blue Lotus', year: '2024', sizeIn: '12 × 12 in', sizeCm: '30 × 30 cm', medium: 'Resin Art on Canvas', price: '$520', status: 'SOLD', col: 'available', src: ART.blueLotus, pal: ['ocean', 'gold'] },
  { t: 'Billabong', year: '2024', sizeIn: '16 × 16 in', sizeCm: '40.5 × 40.5 cm', medium: 'Resin Art on Wood', price: '$520', status: 'ON SALE', col: 'available', src: ART.billabong, pal: ['ocean'] },
  { t: 'Water Splash', year: '2019', sizeIn: '14 × 14 in', sizeCm: '35.5 × 35.5 cm', medium: 'Mixed Media', price: '$520', status: 'ON SALE', col: 'available', src: ART.waterSplash, pal: ['ocean'] },
  { t: 'Desert Storm', year: '2019', sizeIn: '20 × 16 in', sizeCm: '50.5 × 40.5 cm', medium: 'Fluid / Mixed Media', price: '$520', status: 'ON SALE', col: 'available', src: ART.desertStorm, pal: ['nature'] },
  ...
  { t: 'Summer', year: '', sizeIn: '10 × 10 in', sizeCm: '', medium: 'Oil on Canvas', price: null, status: 'SOLD', col: 'acquired', label: 'Acquired during “Layers of Happiness”', src: ART.summer, pal: ['ocean', 'fire'] },
  ...
  { t: 'Goldfields', year: '', sizeIn: '18 × 18 in', sizeCm: '', medium: 'Mixed Media', price: null, status: 'SOLD', col: 'acquired', label: 'Acquired during Da Noi Exhibition', src: ART.goldfields },
  { t: 'Hawaii', year: '', sizeIn: '14 × 14 in', sizeCm: '', medium: 'Mixed Media', price: null, status: 'ACQUIRED', col: 'acquired', label: 'Private Collection · Melbourne', src: ART.hawaii },
  { t: 'Magnolia', year: '', sizeIn: '10 × 10 in', sizeCm: '', medium: 'Resin Art on Wood', price: null, status: 'ACQUIRED', col: 'acquired', label: 'Private Collection · Sydney', src: ART.magnolia },
  { t: 'Lava', year: '', sizeIn: '16 × 20 in', sizeCm: '', medium: 'Mixed Media', price: null, status: 'ACQUIRED', col: 'acquired', label: 'Private Collection · Sydney', src: ART.lava },
  ...
  { t: 'Abyss', year: '', sizeIn: '16 × 12 in', sizeCm: '', medium: 'Mixed Media', price: null, status: 'ACQUIRED', col: 'acquired', label: 'Private Collection · Melbourne', src: ART.abyss },
  { t: 'The Power of Love', year: '', sizeIn: '18 × 36 in', sizeCm: '', medium: 'Mixed Media', price: null, status: 'ACQUIRED', col: 'acquired', label: 'Private Collection', src: ART.powerOfLove },
  ...
  { t: 'Planet', year: '', sizeIn: '14 × 14 in', sizeCm: '', medium: 'Mixed Media', price: null, status: 'ACQUIRED', col: 'acquired', label: 'Private Collection', src: ART.planet },
  { t: 'Marriage', year: '', sizeIn: '18 × 24 in', sizeCm: '', medium: 'Mixed Media', price: null, status: 'ACQUIRED', col: 'acquired', label: 'Private Collection · Melbourne', src: ART.marriage },
